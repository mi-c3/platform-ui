...
class GeoCoding {
     ...
     */
    fromLatLong = async (lat, lng, apiKey = API_KEY) => {
     ...
     * @return {type}         description
     */
    fromAddress = async (address, apiKey = API_KEY) => {
        if (!address) {
